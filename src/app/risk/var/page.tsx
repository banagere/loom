    ...
    <>
      <div className="flex flex-col max-w-3xl mx-auto">
        ...
        <p className="font-medium max-w-xl">
          Quantify the least amount of money you could lose in a given day/year.
          This number helps you to understand risk, and necessary decision on
          whether to increase or decrease your position.
        </p>
      </div>
